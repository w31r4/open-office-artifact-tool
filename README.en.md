...
| DOCX | OpenChestnut C# WASM | Structured text and styles, sections, headers and footers, lists, tables, links, fields, images, classic comments, bounded modern comment threads, and inline plain-text, canonical checkbox, canonical drop-down, canonical combo-box with bounded custom values, or strict `YYYY-MM-DD` date-picker content controls. |
