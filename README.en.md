...
| DOCX | OpenChestnut C# WASM | Structured text and styles, sections, headers and footers, lists, tables, links, fields, images, classic comments, bounded modern comment threads, and inline plain-text, canonical checkbox, or canonical drop-down content controls. |
