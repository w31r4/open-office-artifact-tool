...
This plugin is bundled into the primary runtime.
...
- `excel-live-control`: inspect, edit, verify, and control an open Microsoft Excel workbook through the spreadsheet add-in or a connected Excel session.
