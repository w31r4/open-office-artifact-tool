...
```js
import { FileBlob, SpreadsheetFile } from "office-artifact-tool";
...
import { Workbook } from "office-artifact-tool";
...
```js
import fs from "node:fs/promises";
import { SpreadsheetFile, Workbook } from "office-artifact-tool";
...
- `import { FileBlob, SpreadsheetFile, Workbook } from "office-artifact-tool"`
