...
"""Helpers for public container_tools scripts to resolve agent runtime dependencies."""
...
def _candidate_dependency_roots() -> list[Path]:
    ...
    for env_name in (
        ...
        "ARTIFACT_WORKSPACE_DEPENDENCIES",
    ...
    roots.append(
        Path.home() / ".cache" / "artifact-runtimes" / "artifact-primary-runtime" / "dependencies"
    )
