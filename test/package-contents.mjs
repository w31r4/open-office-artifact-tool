...
for (const required of [
  ...
  "src/codecs/openxml-wasm-error.mjs",
  "src/codecs/openxml-wasm-presentation.mjs",
  ...
  "native/OpenXmlWasm/tests/OpenOffice.OpenXmlCodec.Tests/PptxCodecTests.cs",
  ...
  "skills/presentations/fixtures/openxml-wasm-preservation.json",
