...
try {
  ...
  assert.match(modernSkillCommentsXml, /oac:deMkLst>[\s\S]*?<pc:sldMkLst>[\s\S]*?<oac:spMk id="2" creationId="\{[0-9A-F-]+\}"/);
  ...
  assert.equal(modernSkillThread.targetId, modernSkillTarget.id);
