...
const alignedQa = await visualQaArtifact(pngArtifact, { baseline: new FileBlob(wideBlackPng, { type: "image/png" }), pixelDiff: { diffAlignment: "center", diffPalette: { changed: [255, 128, 0], unchanged: "#112233" } } });
