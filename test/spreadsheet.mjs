...
import { exportXlsxWithOpenXmlWasm, importXlsxWithOpenXmlWasm } from "../src/codecs/openxml-wasm.mjs";
...
const wasmRelocatedDrawingBook = await importXlsxWithOpenXmlWasm(relocatedDrawingBlob);
wasmRelocatedDrawingBook.worksheets.getItem("Sheet1").getRange("A1").values = [["WASM preserved"]];
const wasmRelocatedDrawingRoundtrip = await exportXlsxWithOpenXmlWasm(wasmRelocatedDrawingBook, { recalculate: false });
