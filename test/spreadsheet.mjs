...
chartFromRange.lineOptions = { grouping: "stacked", smooth: true };
...
assert.deepEqual(chartFromRange.lineOptions, { grouping: "stacked", smooth: true });
...
assert.deepEqual(nativeOnlySheet.charts.items[0].lineOptions, { grouping: "stacked", smooth: true });
