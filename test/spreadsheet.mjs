...
chartFromRange.lineOptions = { smooth: true };
...
assert.deepEqual(chartFromRange.lineOptions, { smooth: true });
...
assert.deepEqual(nativeOnlySheet.charts.items[0].lineOptions, { smooth: true });
