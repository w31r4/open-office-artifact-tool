...
try {
  ...
  assert.match(await fs.readFile(wasmResult.qa.summary.files.inspect, "utf8"), /"drawingType":"chart"[\s\S]*"title":"OpenChestnut edited trend"[\s\S]*"fill":"#2563EB"[\s\S]*"Edited metric"[\s\S]*"Edited value"/);
