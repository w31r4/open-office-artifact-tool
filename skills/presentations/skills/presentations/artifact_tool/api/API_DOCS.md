...
- Read or replace a uniquely bound embedded XLSX payload, or the bounded DOCX Office-package profile, without rewriting its OLE shell: [`references/ole-workbooks.spec.md`](./references/ole-workbooks.spec.md).
