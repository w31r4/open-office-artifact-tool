...
- The checked-in `openxml-wasm-preservation.json` fixture crosses JavaScript authoring → bundled C# Open XML SDK import/list-and-text edit/export → JavaScript package/semantic/render QA. It changes character, auto-number, and explicit no-bullet markers while retaining its chart, image, notes, master, theme, parts, and relationships.
