...
export function createWorkbookFromFixture(fixture = {}) {
  ...
  for (const sheetFixture of fixture.sheets || []) {
    ...
    for (const table of sheetFixture.tables || []) {
      const created = sheet.tables.add({ range: table.range, name: table.name, hasHeaders: table.hasHeaders !== false, columnNames: table.columnNames, columnDefinitions: table.columnDefinitions });
