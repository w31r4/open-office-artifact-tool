...
PROVIDERS = {
    ...
    "pypdf": {"kind": "module", "module": "pypdf", "role": "basic structure, attachment quarantine, forms, annotations, rewrite/incremental", "integration": "shipped-thin-script"},
...
TASKS = {
    ...
    "merge-stamp": {"providers": ["pypdf", "pymupdf"], "strategies": ["rewrite"], "input": "existing", "mutation": True},
