...
`catalog.json` lists 20 useful document, presentation, and workbook intents. A `planned` entry is a compatibility target, not an installed template. It must fail explicitly instead of falling back to a visually unrelated design.
