...
const WORKBOOK_HELP_SCHEMAS = {
  ...
  "sheet.charts.add": helpSchema({
    chartType: { type: "string", required: true, description: "Canonical OpenChestnut XLSX chart type: bar, line, pie, area, doughnut, or scatter. Other model names fail closed on export." },
