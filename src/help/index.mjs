...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "paragraph.addField", summary: "Append a logical inline SEQ, REF, or PAGEREF field run. OpenChestnut authors/imports the canonical five-run native graph; imported field position and instruction remain source-bound while cached display text is editable." },
  ...
  { artifactKind: "document", kind: "api", name: "DocumentFile.importDocx", summary: "Import relationship-driven core DOCX semantics through the single bundled OpenChestnut codec. Recognized inline plain-text content controls, canonical inline SEQ/REF/PAGEREF fields, whole-paragraph tracked revisions, whole-block bookmarks, canonical plain-text footnotes/endnotes, bounded bibliography/citation graphs, simple fields, and canonical unrefreshed TOC placeholders are semantic and fixed-topology editable while richer graphs stay source-bound." },
  { artifactKind: "document", kind: "api", name: "exportDocxWithOpenChestnut", summary: "Export bounded DocumentModel paragraphs/runs with inline plain-text w:sdt controls, canonical five-run SEQ/REF/PAGEREF fields, tables, whole-block bookmarks and internal links, plain-text footnotes/endnotes, canonical b:Sources plus whole-paragraph CITATION fields, simple fields, canonical complex TOC placeholders plus updateFields hints, whole-paragraph tracked insertions/deletions, classic comments, validated source-free gridSpan/vMerge tables, and direct text-marker numbering graphs; recognized imports permit bounded fixed-topology content edits through bundled OpenChestnut." },
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "document.addParagraph": helpSchema({
    ...
    runs: { type: "object[]", description: "Optional run spans whose style may include runStyleId plus direct/theme formatting. A run may carry contentControl { id, tag, alias, nativeId? } or inlineField { instruction } for the bounded inline profiles." },
