...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.addSection", summary: "Append a DOCX section break with page size, orientation, margins, binding gutter, canonical equal-width or explicit-width columns, and break-type metadata backed by w:sectPr. Imported geometry is writable only when page-margin mode and column markup are canonical." },
