...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.addSection", summary: "Append a DOCX section break with page size, orientation, top/right/bottom/left margins, binding gutter, and break-type metadata backed by w:sectPr. Imported geometry is writable only when page-margin mode settings are canonical." },
