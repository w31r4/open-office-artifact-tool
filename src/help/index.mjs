...
export const HELP_CATALOG = [
  ...
  { artifactKind: "workbook", kind: "formula", name: "fx.INDEX", category: "lookup-reference", summary: "Return a value from a range by 1-based row and optional column index, preserving an error-valued selector such as a failed MATCH.", examples: ["=INDEX(A2:C4,2,3)"] },
