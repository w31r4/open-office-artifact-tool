...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "DocumentFile.importDocx", summary: "Import relationship-driven core DOCX semantics through the single bundled OpenChestnut codec. Recognized inline plain-text content controls, whole-paragraph tracked revisions, whole-block bookmarks, and canonical plain-text footnotes/endnotes are semantic; bounded controls and note bodies are fixed-topology editable while richer graphs stay source-bound." },
