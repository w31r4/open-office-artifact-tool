...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.contentControls", summary: "List typed mutable handles for recognized inline plain-text, canonical checkbox, and canonical drop-down controls with model and native identity." },
  { artifactKind: "document", kind: "api", name: "document.fillContentControls", summary: "Transactionally fill every recognized inline plain-text control matching an object or Map of tag-to-string entries. Checkbox and drop-down tags do not silently accept text." },
  { artifactKind: "document", kind: "api", name: "document.setCheckboxContentControls", summary: "Transactionally set every recognized canonical checkbox control matching an object or Map of tag-to-boolean entries. Text and drop-down tags do not silently coerce." },
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "document.addParagraph": helpSchema({
    ...
    runs: { type: "object[]", description: "Optional run spans whose style may include runStyleId plus direct/theme formatting. A run may carry contentControl { id, tag, alias, nativeId?, controlType?, checked? } or inlineField { instruction, bookmarkName?, bookmarkNativeId? } for the bounded inline profiles." },
  ...
  "document.contentControls": helpSchema({}, "controls", "DocumentContentControlHandle[]", "Fresh typed handles for recognized inline text, checkbox, and drop-down controls. Tag/alias plus type-specific text, checked, or selectedValue are mutable; drop-down choices, controlType, nativeId, symbol declarations, and topology are source identity."),
  "document.fillContentControls": helpSchema({
    ...
    strict: { type: "boolean", description: "Unknown tags fail before mutation; defaults to true. Checkbox tags are never matched by this text primitive." },
