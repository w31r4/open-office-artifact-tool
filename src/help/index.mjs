...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.addSection", summary: "Append a DOCX section break with page size, orientation, margins, binding gutter, canonical equal-width columns, and break-type metadata backed by w:sectPr. Imported geometry is writable only when page-margin mode and column markup are canonical." },
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "document.addBlockTextContentControl": helpSchema({
    ...
    paragraphFormat: { type: "object", description: "Optional modeled paragraph formatting for the wrapped paragraph." },
  ...
  "document.addSection": helpSchema({
    ...
    columns: { type: "object", description: "Optional canonical equal-width text columns: integer count 1–45, non-negative spacing in twentieths of a point, and boolean separator. Margins, binding-side gutter, and all spacing must leave positive text width; custom-width w:col graphs stay source-owned." },
