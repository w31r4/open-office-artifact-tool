...
const DOCUMENT_HELP_SCHEMAS = {
  "DocumentModel.create": helpSchema({
    ...
    blocks: { type: "object[]", description: "Ordered paragraph/list/table/link/field/citation/image/section/change block models. Canonical bibliography-backed citation blocks cross OpenChestnut; complex field graphs remain source-bound." },
