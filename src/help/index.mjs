...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "DocumentFile.addTrackedReplacement": helpSchema({
    ...
    search: { type: "string", required: true, description: "Non-empty literal that must occur exactly once inside one direct ordinary w:r/w:t node. Duplicate and cross-run matches fail closed." },
