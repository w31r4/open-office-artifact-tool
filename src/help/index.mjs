...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "DocumentModel.create", summary: "Create a document with paragraph/character styles, formatted paragraphs/runs, sections, headers/footers, lists, TableGrid fixed-geometry tables, links, bounded whole-block bookmarks, simple fields, bounded whole-paragraph tracked insertions/deletions, classic comments, and PNG/JPEG images. Arbitrary source-free table-style graphs, bibliography, complex bookmark/revision graphs, modern comment graphs, and advanced settings remain unsupported or import-preserved read-only." },
  ...
  { artifactKind: "document", kind: "api", name: "document.inspect", summary: "Emit bounded NDJSON for document blocks including tracked changes, bookmark ranges, bibliography sources, comments, styles, headers/footers, and layout; narrow with search/target anchors and shape fields with include/exclude." },
  ...
  { artifactKind: "document", kind: "api", name: "document.verify", summary: "Return QA issues for fake lists, invalid links/citations/bibliography sources, malformed tracked changes, duplicate/dangling/reversed bookmark ranges, unknown styles, malformed tables, bad images/sections, dangling comments, visual overflow, and prose-like table cells." },
  ...
  { artifactKind: "document", kind: "api", name: "DocumentFile.importDocx", summary: "Import relationship-driven core DOCX semantics through the single bundled OpenChestnut codec. Recognized whole-paragraph tracked revisions and whole-block bookmarks are semantic; imported bookmarks remain fixed-topology/read-only, while complex revisions/bookmark graphs, bibliography, modern comments, settings, and unsupported content remain source-bound and read-only." },
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "exportDocxWithOpenChestnut": helpSchema({
    document: { type: "DocumentModel", required: true, description: "Document facade within the OpenChestnut paragraph/run/style, section, header/footer, image, list, hyperlink, whole-block bookmark, simple-field, comment, and fixed-table boundary. Advanced imported content remains source-bound; unsupported edits fail closed." },
    limits: { type: "object", description: "Optional maxInputBytes, maxUncompressedBytes, maxParts, maxCells, and maxCompressionRatio codec budgets." },
