...
const HELP_DETAIL_OVERRIDES = {
  ...
  "PdfFile.inspectPdf": {
    ...
    schema: {
      ...
      returns: { inspection: { type: "object", description: "PDF file summary with sourceSha256, tagged/language/structure evidence, bounded indirect object records, source-bound mupdfAnnotation/mupdfLink/mupdfWidget records, and grouped mupdfFormField snapshots. Native Highlight annotations expose their provider quadrilateral selection and RGB color. Native page records include raw MediaBox/CropBox [x,y,width,height] values, normalized right-angle rotation, and an effective visible page-space bbox. Re-inspect after any rewrite because locators cannot identify a later byte sequence." } },
    },
  },
  "PdfFile.renderPdf": {
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "document.addComment": helpSchema({
    ...
    paraId: { type: "string", description: "Optional eight-hex-digit w14/w15 paragraph identity; generated deterministically when omitted for a modern source-free graph." },
