...
const HELP_DETAIL_OVERRIDES = {
  ...
  "PdfFile.inspectPdf": {
    ...
    schema: {
      ...
      returns: { inspection: { type: "object", description: "PDF file summary with tagged/language/structure evidence plus bounded indirect object records. Native page records include raw MediaBox/CropBox [x,y,width,height] values, normalized right-angle rotation, and an effective visible page-space bbox." } },
    },
  },
  "PdfFile.renderPdf": {
