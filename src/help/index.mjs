...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "presentation.slides.insert", summary: "Insert a source-free slide after an existing Slide or 0-based index, or at the beginning with after: null. It uses the same transactional layout materialization as slides.add; imported deck topology remains source-bound." },
