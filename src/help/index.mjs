...
export const HELP_CATALOG = [
  ...
  { artifactKind: "workbook", kind: "api", name: "workbook.verify", summary: "Return bounded QA issues for source-bound connections, sheets, formulas (including reference-budget refusals), tables, charts, and comments." },
  { artifactKind: "workbook", kind: "api", name: "workbook.recalculate", summary: "Recalculate bounded workbook formulas and dynamic-array spills, with dependency edges, cycles, errors, and reference-budget refusals." },
  ...
  { artifactKind: "workbook", kind: "api", name: "workbook.trace", summary: "Return a formula precedent tree and bounded NDJSON trace for a target cell, with circular references and reference-budget refusals flagged." },
  { artifactKind: "workbook", kind: "api", name: "workbook.formulaGraph", summary: "Return a bounded dependency graph of formula nodes, edges, dependents, cycles, formula errors, and reference-budget refusals for workbook QA." },
...
const WORKBOOK_HELP_SCHEMAS = {
  ...
  "workbook.recalculate": helpSchema({}, "graph", "object", "Updated bounded formula dependency graph including cycles, errors, and reference-budget refusals."),
