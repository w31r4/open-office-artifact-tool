...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "presentation.slides.insert", summary: "Insert a source-free slide after an existing Slide or 0-based index, or at the beginning with after: null. It uses the same transactional layout materialization as slides.add; imported deck add/remove/clone topology remains source-bound." },
  { artifactKind: "presentation", kind: "api", name: "slide.moveTo", summary: "Move this slide to an existing 0-based deck index. On an imported PPTX, OpenChestnut preserves each original SlidePart exactly once and rewrites only the presentation slide-ID order; duplicate, delete, and source-part cloning remain fail-closed." },
