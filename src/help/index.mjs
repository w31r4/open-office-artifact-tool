...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "DocumentFile.finalizeRevisions", summary: "Accept or reject the bounded direct whole-paragraph one-run DOCX revision profile from exact source bytes. The mandatory SHA-256 binding, decompression budgets, exact changed-part audit, and fail-closed graph checks prevent silent model reconstruction or broad package mutation." },
