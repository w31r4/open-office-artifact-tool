...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "slide.charts.add": helpSchema({
    chartType: { type: "string", description: "bar, line, pie, or combo for canonical OpenChestnut export. combo is only the literal primary-axis clustered bar+line profile described by series." },
    ...
    position: { type: "object", description: "Pixel left/top/width/height frame." },
    axes: { type: "object", description: "Basic primary category/value axis titles, number formats, intervals, bounds, and major units. Combo shares this one primary axis pair; secondary axes are unsupported." },
