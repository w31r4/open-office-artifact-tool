...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.setTransition", summary: "Set a direct p:transition to bounded fade or directional push behavior with slow/medium/fast speed plus click/timer advancement. Source-free slides may author it; imported slides may replace only one canonical existing direct transition, while absent or opaque source graphs fail closed." },
  { artifactKind: "presentation", kind: "api", name: "slide.clearTransition", summary: "Remove one canonical direct imported or source-free slide transition. A transition-absent imported slide is not an addable authoring surface, and unsupported timing, sound, extension, or effect graphs remain byte-preserved and reject mutation." },
