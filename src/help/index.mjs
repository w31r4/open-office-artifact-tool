...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "importPptxWithOpenChestnut", summary: "Import PPTX bytes with editable bounded direct slide backgrounds, shapes, rich text, pictures, tables, connectors, bar/line/pie charts, and plain-text speaker notes. Complex backgrounds, rich notes, and other unsupported content remain source-bound and read-only." },
