...
const WORKBOOK_HELP_SCHEMAS = {
  ...
  "sheet.charts.add": helpSchema({
    chartType: { type: "string", required: true, description: "Canonical OpenChestnut XLSX chart type: bar, line, pie, area, or doughnut. Other model names fail closed on export." },
    ...
    xAxis: { type: "object", description: "Primary text category axis with title.text, tick-label textStyle.fontSize, numberFormatCode, and tickLabelInterval. Pie and doughnut charts have no axes." },
