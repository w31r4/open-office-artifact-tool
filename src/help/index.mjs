...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.contentControls", summary: "List typed mutable handles for recognized inline plain-text, canonical checkbox, drop-down, and combo-box controls with model and native identity." },
  { artifactKind: "document", kind: "api", name: "document.fillContentControls", summary: "Transactionally fill every recognized inline plain-text control matching an object or Map of tag-to-string entries. Checkbox, drop-down, and combo-box tags do not silently accept text." },
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "document.contentControls": helpSchema({}, "controls", "DocumentContentControlHandle[]", "Fresh typed handles for recognized inline text, checkbox, drop-down, and combo-box controls. Tag/alias plus type-specific text, checked, selectedValue, or value are mutable; list choices, controlType, nativeId, symbol declarations, and topology are source identity."),
  "document.fillContentControls": helpSchema({
    ...
    strict: { type: "boolean", description: "Unknown tags fail before mutation; defaults to true. Checkbox, drop-down, and combo-box tags are never matched by this text primitive." },
