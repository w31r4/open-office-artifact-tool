...
export const HELP_CATALOG = [
  ...
  { artifactKind: "workbook", kind: "api", name: "sheet.pivotTables.add", summary: "Create a native bounded XLSX PivotTable with derived cached output and cache records, or use richer model-only grouping/calculation/filter semantics for inspect and preview. Recognized imports are hash-bound and read-only." },
...
const WORKBOOK_HELP_SCHEMAS = {
  ...
  "sheet.pivotTables.add": helpSchema({
    ...
    rowFields: { type: "string[]", description: "Row field names. Native source-free OpenChestnut authoring currently requires exactly one." },
