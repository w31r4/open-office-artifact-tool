...
const WORKBOOK_HELP_SCHEMAS = {
  ...
  "sheet.pivotTables.add": helpSchema({
    ...
    valueFields: { type: "object[]", description: "Value field and aggregation definitions. Native source-free authoring requires exactly one sum/count/average/min/max field." },
