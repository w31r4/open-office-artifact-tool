  ...
  "PdfFile.editPdf": {
    ...
    schema: {
      parameters: {
        ...
        savePolicy: { type: "string", description: "rewrite or incremental. Incremental is forbidden for redaction, annotation or link mutation, delete operations, and signed input; set_page_crop and rotate_page are non-destructive and may be incremental." },
