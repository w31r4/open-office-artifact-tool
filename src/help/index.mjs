...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.addNotes", summary: "Set plain-text speaker notes for inspect, preview, and canonical PPTX output. OpenChestnut authors source-free notes, edits hash-bound simple imported notes bodies, and adds a canonical NotesSlide to an imported notes-absent slide only when speakerNotes.capability.addable is true. Rich or irregular notes and unsafe NotesMaster graphs fail closed." },
