...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.contentControls", summary: "List typed mutable handles for recognized block/inline plain-text, canonical checkbox, drop-down, combo-box, and date controls with explicit placement plus model and native identity." },
  { artifactKind: "document", kind: "api", name: "document.fillContentControls", summary: "Transactionally fill every recognized block or inline plain-text control matching an object or Map of tag-to-string entries. Checkbox, drop-down, combo-box, and date tags do not silently accept text." },
