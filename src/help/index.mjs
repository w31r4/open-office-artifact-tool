...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "nativeObject.setName", summary: "Native OLE, SmartArt/diagram, contentPart, and media objects imported through OpenChestnut are source-bound and read-only; setName rejects instead of mutating the preserved package graph." },
