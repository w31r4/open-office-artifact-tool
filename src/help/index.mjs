...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "DocumentFile.addTrackedReplacement": helpSchema({
    ...
    targetBlockIndex: { type: "number", required: true, description: "Zero-based semantic body-block index from the exact source document inspect result." },
    expectedText: { type: "string", required: true, description: "Exact full text of the target paragraph; stale text fails closed before mutation." },
