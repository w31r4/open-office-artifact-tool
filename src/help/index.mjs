  ...
  "PdfFile.inspectPdf": {
    ...
    schema: {
      parameters: {
        ...
        limits: { type: "object", description: "Input, page, object, and annotation budgets applied before or during native inspection." },
        maxObjects: { type: "number", description: "Maximum indirect object records to inspect." },
        maxChars: { type: "number", description: "Maximum bounded NDJSON output size." },
      },
      returns: { inspection: { type: "object", description: "PDF file summary with sourceSha256, tagged/language/structure evidence, bounded indirect object records, and source-bound mupdfAnnotation records. Native page records include raw MediaBox/CropBox [x,y,width,height] values, normalized right-angle rotation, and an effective visible page-space bbox." } },
    },
  },
  "PdfFile.renderPdf": {
