...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.contentControls", summary: "List typed mutable handles for recognized inline plain-text and canonical checkbox controls with model and native identity." },
  { artifactKind: "document", kind: "api", name: "document.fillContentControls", summary: "Transactionally fill every recognized inline plain-text control matching an object or Map of tag-to-string entries. Checkbox tags do not silently accept text." },
  { artifactKind: "document", kind: "api", name: "document.setCheckboxContentControls", summary: "Transactionally set every recognized canonical checkbox control matching an object or Map of tag-to-boolean entries. Text-control tags do not silently coerce." },
...
const DOCUMENT_HELP_SCHEMAS = {
  ...
  "document.contentControls": helpSchema({}, "controls", "DocumentContentControlHandle[]", "Fresh typed handles for recognized inline text and checkbox controls. Tag/alias and the type-specific text or checked value are mutable; controlType, nativeId, symbol declarations, and topology are source identity."),
