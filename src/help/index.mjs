...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.contentControls", summary: "List typed mutable handles for recognized block, inline, or table-cell plain-text controls plus canonical checkbox, drop-down, combo-box, and date controls, with explicit placement and model/native identity." },
