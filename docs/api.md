...
| `slide.charts.add` | api | Add an inspectable bar/line/pie chart facade with standard chart style IDs, color variation, series fill/line formatting, point overrides, bar direction/grouping/gap/overlap, line markers/smoothing, axes, legend, data labels, layout JSON, SVG preview, and native PPTX chart output. |
...
Add an inspectable bar/line/pie chart facade with standard chart style IDs, color variation, series fill/line formatting, point overrides, bar direction/grouping/gap/overlap, line markers/smoothing, axes, legend, data labels, layout JSON, SVG preview, and native PPTX chart output.
...
- `categories` (string[]) required — Category labels.
- `series` (object[]) required — Series with names, numeric values, fill/color, line/stroke width and dash style, indexed point fill/line overrides, and line marker/smooth options.
