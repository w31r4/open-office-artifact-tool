...
| `sheet.pivotTables.add` | api | Create a clean-room pivot table facade with row/column cross-tabs, arithmetic calculated fields, item and absolute whole-day date filters, refresh/save policy, computed summary values, inspect/resolve/layout records, and native OOXML roundtrip. |
...
Create a clean-room pivot table facade with row/column cross-tabs, arithmetic calculated fields, item and absolute whole-day date filters, refresh/save policy, computed summary values, inspect/resolve/layout records, and native OOXML roundtrip.
