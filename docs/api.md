...
| `exportDocxWithOpenChestnut` | api | Experimentally export bounded DocumentModel paragraphs/runs/tables and source-bound hyperlinks, simple fields, fixed-topology table-cell text, or direct-numbered single-run paragraph text through the bundled OpenChestnut codec. |
...
Experimentally export bounded DocumentModel paragraphs/runs/tables and source-bound hyperlinks, simple fields, fixed-topology table-cell text, or direct-numbered single-run paragraph text through the bundled OpenChestnut codec.

**Schema parameters:**

- `document` (DocumentModel) required — Document facade within the current paragraph/run/table authoring boundary or carrying validated source bindings for hyperlinks, simple fields, fixed-topology table-cell text, and direct-numbered single-run paragraph text from the OpenChestnut importer.
