...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally (`43` tests); the latest hosted baseline [`29310339834`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29310339834) remains green at `41` tests while the numbered-paragraph slice awaits its push. Coverage includes all three Office families, DOCX source-bound hyperlinks/simple fields/fixed-topology table text/direct-numbered paragraph text, PPTX owner-local master/layout/slide semantics, exact package guards, and Office 2021 validation. The hosted gate also requires canonical OpenChestnut plus legacy-alias tests, bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, npm clean-install, and OfficeBridge tests.
