...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally with `60` tests. The XLSX number-format corpus proves source-free built-in/custom authoring, semantic reimport, source-preserving XF cloning with alignment/protection residue, byte-stable untouched styles, and structured invalid-style/missing-format/code-budget failures; the preceding DOCX/PPTX corpus remains green. Local macOS produces 38 runtime files/12,997,820 bytes; two isolated 39-file snapshots are byte-identical; the 210-file no-local-dotnet clean install passes; and the OpenChestnut→OpenChestnut spreadsheet fixture passes custom/percentage formats through modeled, package, Playwright, and LibreOffice/Poppler QA. Hosted evidence for this increment is pending. The preceding hosted Linux runs [`29343501551`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29343501551) and [`29343983983`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29343983983) passed OpenChestnut 56/56, OfficeBridge 5/5, and real Chromium/LibreOffice/Poppler.
