...
- The dry-run npm tarball contains 391 files, is 9,049,421 bytes compressed and 22,295,140 bytes unpacked. It includes the rich PDF Skill tasks/references/examples and thin provider scripts while excluding Python bytecode/cache files, development harnesses, private reference material, and removed Office codec paths.
