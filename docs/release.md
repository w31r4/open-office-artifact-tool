...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally and in hosted Linux CI (`25` tests). PPTX coverage includes character/auto/none and embedded/external picture markers; content-addressed asset hash/signature/safe-SVG/URI validation; cross-slide media sharing; source-preserving picture replacement/deletion with old graph retention; marker styles; links; ordered text/field/line-break inlines; tab stops; unknown transformed marker/property preservation; topology rejection; exact package guards; and Office 2021 validation. Hosted run [`29281200299`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29281200299) also passes bundled-runtime reproducibility, Chromium, LibreOffice/Poppler, clean-install packaging, and OfficeBridge gates.
