...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`16` tests), including PPTX basic rich-text roundtrip/editing, unmodeled paragraph/run-property retention, fixed-topology rejection, XLSX/DOCX/PPTX hash/source/opaque-graph or element-binding preservation, unsupported-advanced-edit rejection, and fail-closed Office 2021 validation. Hosted run [`29267402425`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29267402425) passed the preceding runtime/protocol, complex bundled-runtime, Chromium/LibreOffice/Poppler, clean-install, and .NET gates; hosted evidence for the rich-text increment is pending.
