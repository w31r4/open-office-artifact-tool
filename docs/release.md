...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`15` tests), including XLSX/DOCX/PPTX hash/source/opaque-graph or element-binding preservation, unsupported-advanced-edit rejection, and fail-closed Office 2021 validation. Hosted run [`29267402425`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29267402425) passed reproducible runtime/protocol verification, complex bundled-runtime fixtures for all three Office families, Chromium/LibreOffice/Poppler rendering, clean-install packing, and both .NET test suites.
