...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`25` tests). PPTX coverage includes character/auto/none and embedded/external picture markers; content-addressed asset hash/signature/safe-SVG/URI validation; cross-slide media sharing; source-preserving picture replacement/deletion with old graph retention; marker styles; links; ordered text/field/line-break inlines; tab stops; unknown transformed marker/property preservation; topology rejection; exact package guards; and Office 2021 validation. Hosted Linux run [`29278323213`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29278323213) remains evidence for the preceding 22-test field/break/tab-stop gate until the current picture-marker increment completes hosted CI.
