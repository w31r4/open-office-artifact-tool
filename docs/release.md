...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`20` tests), including PPTX character/auto/none marker and explicit/follow-text font/RGB-color/fixed-or-percentage-size authoring and edits; external URI, internal slide, and relative-action run-link authoring/edit/deletion; real relationship-backed picture-marker plus unknown scheme-color/custom-show-link preservation; invalid marker/style/link rejection; basic rich-text roundtrip/editing; unmodeled paragraph/run-property retention; fixed-topology rejection; XLSX/DOCX/PPTX hash/source/opaque-graph or element-binding preservation; unsupported-advanced-edit rejection; and fail-closed Office 2021 validation. Hosted Linux run [`29275741125`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29275741125) passed the complete Chromium/LibreOffice/Poppler, reproducible-runtime, clean-install package, OfficeBridge, and 20-test OpenXmlWasm hyperlink gate.
