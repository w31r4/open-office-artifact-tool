...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`17` tests), including PPTX character/auto/none marker authoring and edits, real relationship-backed picture-marker preservation, invalid marker rejection, basic rich-text roundtrip/editing, unmodeled paragraph/run-property retention, fixed-topology rejection, XLSX/DOCX/PPTX hash/source/opaque-graph or element-binding preservation, unsupported-advanced-edit rejection, and fail-closed Office 2021 validation. Hosted Linux run [`29271655311`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29271655311) passed the complete Chromium/LibreOffice/Poppler, reproducible-runtime, package, OfficeBridge, and 17-test OpenXmlWasm gate for this increment.
