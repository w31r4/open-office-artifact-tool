...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`27` tests). PPTX coverage includes character/auto/none and embedded/external picture markers; direct left-margin/hanging-indent author/import/edit/delete; RGB/follow-text and 16 untransformed theme marker colors; transformed-color preservation; content-addressed asset validation and cross-slide media sharing; source-preserving old graph retention; links; ordered text/field/line-break inlines; tab stops; unknown property preservation; topology rejection; exact package guards; and Office 2021 validation. Hosted run [`29282648695`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29282648695) remains evidence for the preceding 26-test theme-color slice until this paragraph-layout increment completes hosted CI.
