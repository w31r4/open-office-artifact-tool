...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`16` tests), including PPTX basic rich-text roundtrip/editing, unmodeled paragraph/run-property retention, fixed-topology rejection, XLSX/DOCX/PPTX hash/source/opaque-graph or element-binding preservation, unsupported-advanced-edit rejection, and fail-closed Office 2021 validation. Hosted run [`29269870489`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29269870489) passed reproducible runtime/protocol verification, complex bundled-runtime fixtures including PPTX rich-text edit/preservation, Chromium/LibreOffice/Poppler rendering, clean-install packing, and both .NET test suites.
