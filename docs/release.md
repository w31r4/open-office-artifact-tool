...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`26` tests). PPTX coverage includes character/auto/none and embedded/external picture markers; RGB/follow-text and 16 untransformed theme marker colors; transformed-color preservation; content-addressed asset validation and cross-slide media sharing; source-preserving picture replacement/deletion with old graph retention; links; ordered text/field/line-break inlines; tab stops; unknown marker/property preservation; topology rejection; exact package guards; and Office 2021 validation. Hosted run [`29281200299`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29281200299) remains evidence for the preceding 25-test picture-asset slice until this theme-color increment completes hosted CI.
