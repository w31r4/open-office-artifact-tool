...
- The dry-run npm tarball contains 395 files, is 9,065,997 bytes compressed and 22,341,356 bytes unpacked. It includes the rich PDF Skill tasks/references/examples, the shipped Spreadsheet Range workflow, and the dependency-leaf Range/chart-source modules while excluding Python bytecode/cache files, development harnesses, private reference material, and removed Office codec paths.
