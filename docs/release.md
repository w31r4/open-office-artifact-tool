...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally and on hosted Linux (`39` tests). Coverage includes all three Office families, DOCX source-bound hyperlinks/simple fields, PPTX owner-local master/layout/slide semantics, exact package guards, and Office 2021 validation. Hosted run [`29309300830`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29309300830) passes canonical OpenChestnut plus legacy-alias tests, bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, the 199-file npm clean-install, and the OfficeBridge tests.
