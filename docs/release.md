...
- The dry-run npm tarball contains 359 files, is 9,011,583 bytes compressed and 22,152,369 bytes unpacked. The additional file is the runnable Documents OpenChestnut example; development harnesses, private reference material, and removed Office codec paths remain excluded.
