...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally (`45` tests) and on the prior hosted Linux milestone (`43` tests). Local coverage adds DOCX explicit paragraph-style-inherited numbering plus cyclic-chain read-only behavior to the existing all-family, hyperlink/simple-field/fixed-table/direct-numbering, PPTX owner-local, exact package-guard, and Office 2021 gates. Hosted run [`29313871129`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29313871129) remains the latest completed evidence for canonical OpenChestnut plus legacy-alias tests, bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, the 201-file npm clean-install, and OfficeBridge tests; refreshed hosted evidence is pending this milestone's push.
