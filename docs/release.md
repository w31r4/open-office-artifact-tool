...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`22` tests), including PPTX character/auto/none marker and explicit/follow-text font/RGB-color/fixed-or-percentage-size authoring and edits; external URI, internal slide, and relative-action link authoring/edit/deletion; ordered text/field/line-break inlines; tab-stop authoring/edit/deletion; unknown field paragraph and break run-property preservation; invalid inline/tab/marker/style/link rejection; fixed-kind topology rejection; XLSX/DOCX/PPTX hash/source/opaque-graph or element-binding preservation; unsupported-advanced-edit rejection; and fail-closed Office 2021 validation. Hosted Linux run [`29278323213`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29278323213) passed the complete Chromium/LibreOffice/Poppler, reproducible-runtime, clean-install package, OfficeBridge, and 22-test OpenXmlWasm field/break/tab-stop gate.
