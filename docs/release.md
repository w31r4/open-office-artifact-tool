...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally and on hosted Linux (`28` tests). PPTX coverage includes character/auto/none and embedded/external picture markers; direct left-margin/hanging-indent and point/multiplier line/before/after spacing author/import/edit/delete; RGB/follow-text and 16 untransformed theme marker colors; transformed-color preservation; content-addressed asset validation and cross-slide media sharing; source-preserving old graph retention; links; ordered text/field/line-break inlines; tab stops; unknown property preservation; topology rejection; exact package guards; and Office 2021 validation. Hosted run [`29285803150`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29285803150) also passes bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, the 184-file npm clean-install, and the OfficeBridge tests.
