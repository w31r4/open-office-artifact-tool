...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally and the pre-rename codec milestone passed hosted Linux (`39` tests). Coverage includes all three Office families, DOCX source-bound hyperlinks/simple fields, PPTX owner-local master/layout/slide semantics, exact package guards, and Office 2021 validation. Hosted run [`29301993212`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29301993212) also passed bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, the 195-file npm clean-install, and the OfficeBridge tests. A post-rename hosted run is required before this migration milestone is considered closed.
