...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally with `56` tests. The new table-format tests prove schema-valid fixed table/grid/cell widths, indent/margins/borders/header styling, semantic reimport, invalid width/border rejection, and source-bound formatting; the direct-numbering and numbering-planner corpus remains green. Local macOS produces 38 runtime files/12,979,388 bytes. Hosted run [`29340497565`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29340497565) remains the preceding green 55-test/208-file baseline until this slice is pushed; it includes real Chromium/LibreOffice/Poppler, reproducible bundled runtime, clean install, and OfficeBridge 5/5.
