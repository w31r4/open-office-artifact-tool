...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally and on hosted Linux (`43` tests). Coverage includes all three Office families, DOCX source-bound hyperlinks/simple fields/fixed-topology table text/direct-numbered paragraph text, PPTX owner-local master/layout/slide semantics, exact package guards, and Office 2021 validation. Hosted run [`29313871129`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29313871129) also passes canonical OpenChestnut plus legacy-alias tests, bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, the 201-file npm clean-install, and OfficeBridge tests.
