...
- The dry-run npm tarball contains 401 files, is 9,099,383 bytes compressed and 22,495,778 bytes unpacked. It includes the rich PDF Skill tasks/references/examples and canonical audit validator/schema, the shipped Spreadsheet Range and sparkline workflows, and the dependency-leaf Range/chart-source/sparkline modules while excluding Python bytecode/cache files, development harnesses, private reference material, Agent PromptBench oracles, and removed Office codec paths.
