...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`11` tests), including XLSX/DOCX hash/source/opaque-graph or block-binding preservation, unsupported-advanced-edit rejection, and fail-closed Office 2021 validation. Hosted run [`29264703143`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29264703143) passed reproducible runtime/protocol verification, the complex XLSX and DOCX bundled-runtime fixtures, Chromium/LibreOffice/Poppler rendering, clean-install packing, and both .NET test suites.
