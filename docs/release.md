...
- The repository-only Agent PromptBench defines 30 black-box cases (19 PDF and 11 Office; 10 ready and 20 asset-required). The seven deterministic ready PDF cases already materialize isolated candidate trials with an npm-packed install and read-only source hashes. The ready Office set includes a generated XLSX threaded-comment direct-reply/resolve workflow with an independent package XML/original-identity/order/no-note-downgrade oracle, a generated DOCX classic-comment text-only workflow with independent `comments.xml`/body-anchor/metadata/no-modern-graph checks, and a generated PPTX title-and-plain-text-speaker-notes workflow. The PPTX oracle demands fixed slide order/name/background/supporting text, exactly the selected slide XML plus notes XML as changed parts, byte-stable appendix package/render canaries, byte-bound public OpenChestnut rewrite audit, second import, and LibreOffice/Poppler final rendering. All ready Office routes bind byte-bound audit/trace checks and final native rendering. Its first clean XLSX candidate trial, at `d558a924ad63528f2b2dca5e1bbeb1fb0dc120a7`, passed `100/100` across all machine, visual, security, and trace checks using package SHA-256 `f6889efc2cff246b59bc557761e998299fdb30466d98111096d25d562d72f618`; it is one trial, not a repeat matrix or reference-Skill comparison. One clean DOCX candidate trial at `b06f6ca067666b5774bb81fb23155f1cec50e694` likewise passed `100/100` using package SHA-256 `46213b74732657e9bd855f00fa4603e681de9af404d0a321b795846131a08447`; it is one trial, not a repeat matrix or reference-Skill comparison. One clean PPTX candidate trial at `450017eb8acb209f6ceb161d247f6c8059ab2571` likewise passed `100/100` across 5 machine, 2 visual, 2 security, and 6 trace checks using package SHA-256 `d34cef537115fec4cb90f3f2acd2bcead92aa709a9796f3d2242466b18327001`; it is one trial, not a repeat matrix or reference-Skill comparison. A candidate/reference PDF preparation uses byte-identical package tarballs and prompts while varying only the copied Skill. Generic grading covers fail-closed branching, immutable file/directory inputs, read-only prompt/Skill/dependency trees, regular output types, and exact deliverables; the 20 corpus/PKI cases remain explicitly asset-required.
