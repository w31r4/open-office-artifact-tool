...
- `dotnet test native/OpenChestnut/OpenChestnut.sln --configuration Release` passes locally and on hosted Linux (`41` tests). Coverage includes all three Office families, DOCX source-bound hyperlinks/simple fields/fixed-topology table text, PPTX owner-local master/layout/slide semantics, exact package guards, and Office 2021 validation. Hosted run [`29310339834`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29310339834) passes canonical OpenChestnut plus legacy-alias tests, bundled-runtime reproducibility, Chromium, LibreOffice, Poppler, the 200-file npm clean-install, and the OfficeBridge tests.
