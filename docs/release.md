...
- `dotnet test native/OpenXmlWasm/OpenXmlWasm.sln --configuration Release` passes locally (`7` tests), including hash/source/opaque-graph preservation and fail-closed Office 2021 validation. The bounded and complex XLSX fixtures pass bundled-runtime, all-sheet Playwright, LibreOffice, and Poppler gates. Hosted Linux run [`29257565233`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29257565233) passed the final source-preservation, arbitrary-path, native-page, package, and .NET gates.
