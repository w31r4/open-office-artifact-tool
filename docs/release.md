...
- The dry-run npm tarball contains 398 files, is 9,092,671 bytes compressed and 22,475,606 bytes unpacked. It includes the rich PDF Skill tasks/references/examples, the shipped Spreadsheet Range and sparkline workflows, and the dependency-leaf Range/chart-source/sparkline modules while excluding Python bytecode/cache files, development harnesses, private reference material, Agent PromptBench oracles, and removed Office codec paths.
