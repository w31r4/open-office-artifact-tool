...
Hosted Linux run [`29295118831`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29295118831) passes the 32-test master/layout codec slice, a reproducible 38-file/12,836,039-byte runtime build, the 190-file clean-install package, and real Chromium/LibreOffice/Poppler gates.
