...
Hosted Linux run [`29291586145`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29291586145) passes the 31-test codec, reproducible runtime, 189-file clean-install package, and real Chromium/LibreOffice/Poppler gates for this slice.
