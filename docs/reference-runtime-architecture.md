...
The background slice passes 33 local codec tests, a 38-file/12,849,863-byte runtime build, the 191-file clean-install package, and real Chromium/LibreOffice/Poppler gates. Hosted Linux run [`29295118831`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29295118831) remains the preceding master/layout-identity baseline; fresh hosted evidence is pending.
