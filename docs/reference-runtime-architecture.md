...
Hosted Linux run [`29289624878`](https://github.com/w31r4/open-office-artifact-tool/actions/runs/29289624878) passes the 30-test codec, reproducible runtime, 187-file clean-install package, and real Chromium/LibreOffice/Poppler gates for this slice.
