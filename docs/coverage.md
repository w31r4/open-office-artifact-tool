...
| Stable anchor IDs + `resolve(...)` | partial | Implemented for workbook/sheets/tables/charts/images/sparklines/rules/comments, presentation theme/layout/slides/shapes/tables/charts/images/connectors/comments, document blocks/headers/footers/comments/styles, and PDF pages/text/text-items/regions/tables/images. Needs text-range anchors and richer imported-object identity preservation. |
