...
| `presentation.export` image preview/montage | partial | SVG preview implemented for shapes, tables, charts, and image placeholders, and can be rasterized to PNG/WebP/PDF through the optional Playwright renderer adapter. Needs montage and richer DrawingML fidelity. |
